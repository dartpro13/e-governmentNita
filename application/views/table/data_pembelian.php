            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url() ?>/proses/edit_pembelian/<?php echo $value->no_pembelian ?>">
                      <i class="fa fa-edit"></i>
                    </a>
                    <a href="<?php echo site_url() ?>/proses/delete_pembelian/<?php echo $value->no_pembelian ?>">
