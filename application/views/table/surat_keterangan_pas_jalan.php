              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $value->jabatan ?></td>
                   ...
                   ?>
                  <td>
                    <a href="<?php echo site_url() ?>/proses/edit_surat_keterangan_pas_jalan/<?php echo $value->id_surat ?>">
                      <i class="fa fa-edit"></i>
                    </a>
                    <!-- <a href="<?php echo site_url() ?>/proses/delete/<?php echo $value->id_surat ?>">
                      <i class="fa fa-remove"></i>
                    </a> -->
                    <a href="<?php echo site_url() ?>/cetak/suratketeranganpasjalan/<?php echo $value->id_surat ?>" target="_blank">
