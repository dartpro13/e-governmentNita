       ...
       <div class="col-md-12">
         ...
         <div class="box box-primary">
           ...
           foreach ($penduduk as $data) {
            ...
            ?>
           <?php if($status=="edit"){
             ?><form role="form" action="<?php echo site_url() ?>/proses/edit_surat_keterangan_usaha_act/<?= $idS;?>" method="POST">
             <?php
           } else if($status=="create"){
             ?><form role="form" action="<?php echo site_url() ?>/onsite/simpan_surat_keterangan_usaha" method="POST">
             <?php
           }?>
